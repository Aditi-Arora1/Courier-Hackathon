...
const Glass = () => {
    const [notify, setNotify] = useState("Get Notified")
  ...
  return (
    <div className='pt-32 bg-cyan-50'>
        ...
        <button onClick={Notification} className='fixed px-2 py-1 font-bold rounded-lg bg-blue-400 text-white top-[6.0rem] right-40'>{notify}</button>
